...
install-dlg-step3 = 3. Pairing with Wireless Debugging in Shizuku
install-dlg-open-wireless-debug = Open Wireless Debugging Settings
install-dlg-step4 = 4. Return to Bingtray and tap 'Retry Detection'
...
install-dlg-guide-url = https://bingtray.pages.dev/docs/installation
...
# Main UI (bingtray.rs)
status-fetching-all = Fetching Bing images and historical data...
status-fetching-images = Fetching Bing images...
status-downloading-history = Downloading historical data...
status-loading-page = Loading more images (page { $page })...
status-loading-high-res = Loading high resolution image...
image-title-label = Title: { $title }
image-copyright-label = Copyright: { $copyright }
button-set-wallpaper = Set this Wallpaper
